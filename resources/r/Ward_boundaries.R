...
# ward boundaries
Ward_boundaries <- readShapePoly("Wards_December_2015_Full_Extent_Boundaries_in_Great_Britain.shp")
...
Wardnames <- read.csv("Ward_Ages_Output.csv", stringsAsFactors = F)
...
#### output
writePolyShape(GM_Ward_boundaries, "GM_Ward.shp")
